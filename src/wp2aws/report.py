...
def render_text_report(profile: SiteProfile, decision: SizingDecision, cost: CostEstimate) -> str:
    lines: list[str] = []
...
def render_markdown_report(profile: SiteProfile, decision: SizingDecision, cost: CostEstimate) -> str:
    text = render_text_report(profile, decision, cost)
